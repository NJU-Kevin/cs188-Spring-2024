...
def joinFactors(factors: List[Factor]):
    ...
    variableDomainsDict = list(factors)[0].variableDomainsDict() if factors else {}
    newFactor = Factor(unconditionedVariables, conditionedVariables, 
                  variableDomainsDict)
    # Next for each assignmentDict, update the probability 
    # (should be the product of probabilities of assignmentDict of factor in 
    # factors)
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        eliminatedValueList = variableDomainsDict[eliminationVariable]
        newFactor = Factor(unconditionedVariables, conditionedVariables, 
                            variableDomainsDict)
        for assignmentDict in newFactor.getAllPossibleAssignmentDicts():
            prob = 0
            for value in eliminatedValueList:
