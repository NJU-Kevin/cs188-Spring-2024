...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        distance = [self.distancer.getDistance(pacmanPosition, ghostPosition)
                     for ghostPosition in mostLikelyPosition]
        closestPosition = mostLikelyPosition[distance.index(min(distance))]
        successorPosition = [Actions.getSuccessor(pacmanPosition, action) 
                             for action in legal]
        successorDistance = [self.distancer.getDistance(suc, closestPosition) 
                             for suc in successorPosition]
