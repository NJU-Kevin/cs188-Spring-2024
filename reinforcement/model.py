...
class DeepQNetwork(Module):
    ...
    def __init__(self, state_dim, action_dim):
        ...
        self.layer3 = Linear(128, action_dim)
    ...
    def get_loss(self, states, Q_target):
        ...
        """
        "*** YOUR CODE HERE ***"
        qTargetTensor = tensor(Q_target)
        qPrediction = self.forward(states)
        return mse_loss(qPrediction, qTargetTensor)
    ...
    def forward(self, states):
        ...
        """
        "*** YOUR CODE HERE ***"
        statesTensor = tensor(states)
        x = relu(self.layer1(statesTensor))
